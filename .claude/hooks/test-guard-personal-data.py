...
HOOK = "/home/diego/src/postio/.claude/hooks/guard-personal-data.py"
REPO = "/home/diego/src/postio"
FIXTURE = f"{REPO}/crates/postio-model/tests/corpus/x.eml"

# (tool, file_path, text, expected)
CASES = [
    # --- must deny -------------------------------------------------------
    ("Write", FIXTURE, "From: Ada <ada@icloud.com>", "deny"),
    ("Write", FIXTURE, "From: someone@gmail.com", "deny"),
    ("Edit", f"{REPO}/crates/postio-imap/src/x.rs",
     'let a = "diego@icloud.com";', "deny"),
    ...
    ("Write", f"{REPO}/scripts/check-no-personal-data.py",
     "# blocks person@icloud.com", "allow"),
