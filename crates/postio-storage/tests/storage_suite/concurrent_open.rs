...
// SPIKE: `an_empty_key_string_produces_the_reported_error` lived here and is
// gone with SQLCipher. Every case in it was about SQLCipher's own `PRAGMA
// key` acceptance rules and about `cipher_memory_security`, neither of which
// this build has -- so it asserted nothing about what ships and would have
